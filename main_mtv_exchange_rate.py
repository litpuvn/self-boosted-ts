...
from ts_model import create_model, create_model_mtv_exchange_rate, \
...
if __name__ == '__main__':
    ...
    data_dir = 'data'
    output_dir = 'output/exchange-rate/mtv/lag' + str(time_step_lag)
    ...
    model = create_model_mtv_exchange_rate(horizon=HORIZON, nb_train_samples=len(X_train),
